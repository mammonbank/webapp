    ...
    content: [
        ...
        },
        {
            ...
            content: [
                ...
                {
                    elem: 'agreement',
                    content: 'Внимательно прочитайте договор об оказании услуг:<br>' +
                    'Ваш возраст на момент заполнения заявки составляет не менее 18 лет и до даты окончательного срока погашения кредита не превысит 65 лет;<br>' +
                    'Вы являетесь гражданином РБ либо иностранным гражданином, имеющим вид на жительство;<br>'+
                    'Вы официально трудоустроены на последнем месте работы не менее 3 (трех) месяцев и получаете доходы на территории РБ (в случае принятия предварительного положительного решения готовы подтвердить это документально). В качестве получаемого дохода, Банк принимает в расчет доходы, получаемые от индивидуальной предпринимательской деятельности;<br>'+
                    ...
                    'По данной заявке Банк принимает предварительное решение и не делает никаких заявлений и не дает никаких выраженных или подразумеваемых гарантий Заявителю по поводу приобретаемых услуг и имущества (предоставление кредита), а также окончательных условий кредитования. Если Вы до сих пор это читаете, неужели Вам больше нечем заняться? Принятие Банком данного заявления к рассмотрению, а также возможные расходы Заявителя на оформление необходимых для получения кредита, документов, проведение экспертиз и т.п. не является обязательством Банка предоставить кредит или возместить понесенные издержки;<br>'+
